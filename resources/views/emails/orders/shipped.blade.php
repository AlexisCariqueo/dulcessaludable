...
<body>
    <div style="width: 100%; padding: 20px; background: #f8f9fa; color: #343a40;">
        ...
        <p>Su Orden ID {{ $order->id }} Esta en Camino!, puede que el conductor te llame al número que está en tu perfil para avisarte que está a minutos de llegar, esperamos que disfrutes tu productos tanto como nosotros disfrutamos haciéndolo.</p>
