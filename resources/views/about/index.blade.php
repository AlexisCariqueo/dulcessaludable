    ...
    <div class="container mt-5">
        <div class="card">
            <div class="card-body">
                ...
                <img src="{{ asset('https://www.clinicalascondes.cl/getattachment/8845c80d-ce94-43c5-9a57-3b35081a5c5d/') }}" alt="Imagen de Compromiso con la Salud" class="img-fluid">
                ...
                <img src="{{ asset('https://www.hogarmania.com/archivos/201902/sustitutos-saludables-dulces-caseros-668x400x80xX.jpg') }}" alt="Imagen de Años de Experiencia" class="img-fluid">
                ...
                <img src="{{ asset('https://concepto.de/wp-content/uploads/2015/08/familia-extensa-e1591818033557.jpg') }}" alt="Imagen de Misión" class="img-fluid">
            </div>
        </div>
    </div>
